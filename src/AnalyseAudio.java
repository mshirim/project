        ...
        while (++h < 100000)    
        {
            ...
            {	
                                                                                            ...
                                                                                            //relatively high
                {
                    ...
                    if(a2>700 && b2>700 && c2>700 && d2>700 && e2>700 && f2>700&& (i+2)<lst.size())
                    {
                        arr3= lst.get(i+2);
                        ...
                        if(a3>700 && b3>700 && c3>700 && d3>700 && e3>700 && f3>700 && (i+3)<lst.size())
                        {
                            arr4= lst.get(i+3);
                            ...
                            if(a4>700 && b4>700 && c4>700 &&d4>700 && e4>700 && f4>700 && (i+4)<lst.size())
                            {
                                arr5= lst.get(i+4);
                                ...
                                if(a5>700 && b5>700 && c5>700 &&d5>700 && e5>700 && f5>700 && (i+5)<lst.size())
                                {
                                    arr6= lst.get(i+5);
